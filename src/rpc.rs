...
pub mod rpc_solana_like {
    use {
        crate::{
            payload::RpcSendTransactionConfigWithPolicies, rpc::invalid_params,
    ...
    pub trait Rpc {
        ...
        async fn send_transaction(
            &self,
            data: String,
            config: Option<RpcSendTransactionConfigWithPolicies>,
        ) -> RpcResult<String>;
    }
    ...
    impl RpcServer for RpcServerImpl {
        ...
        async fn send_transaction(
            &self,
            data: String,
            config_with_policies: Option<RpcSendTransactionConfigWithPolicies>,
        ) -> RpcResult<String /* Signature */> {
            debug!("send_transaction rpc request received");
            let config_with_policies = config_with_policies.unwrap_or_default();
