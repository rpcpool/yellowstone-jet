...
pub mod grpc {
    ...
    use {
        crate::discovery::{
            ...
            grpc::jet_quic_service_discovery_client::JetQuicServiceDiscoveryClient,
        },
        futures::Stream,
        std::{
            future::Future,
    ...
    pub struct GrpcJetQuicTopologyStream {
    ...
    impl GrpcJetQuicTopologyStream {
        ...
        fn new(
            client: JetQuicServiceDiscoveryClient<InterceptedService<Channel, XTokenInterceptor>>,
        ) -> Self {
    ...
    impl Stream for GrpcJetQuicTopologyStream {
    ...
    impl TryFrom<JetEndpoint> for JetQuicNodeInfo {
        ...
        fn try_from(endpoint: JetEndpoint) -> Result<Self, Self::Error> {
            ...
            let port = u16::try_from(endpoint.port).map_err(|_| {
                TopologyConversionError::PortOutOfRange {
                    name: endpoint.name.clone(),
                    port: endpoint.port,
                }
            })?;
    ...
    pub struct GrpcTritonJetSvcDiscovery {
        client: JetQuicServiceDiscoveryClient<InterceptedService<Channel, XTokenInterceptor>>,
    }

    impl GrpcTritonJetSvcDiscovery {
        pub fn new(endpoint: &str, x_token: &str) -> Result<Self, tonic::transport::Error> {
        ...
        pub fn topology_stream(&self) -> GrpcJetQuicTopologyStream {
            GrpcJetQuicTopologyStream::new(self.client.clone())
        }
    }
}
