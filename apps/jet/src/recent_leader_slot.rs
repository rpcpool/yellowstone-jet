//! This module comes from https://github.com/anza-xyz/agave/blob/60dc7b698dd77e5055389f334f29ec03f6c07751/tpu-client-next/src/node_address_service/recent_leader_slots.rs#L1
//!
//! All rights reserved to the original authors. The code has been modified to fit the Yellowstone Jet project.
//!
//!
use {solana_clock::Slot, std::collections::VecDeque};
