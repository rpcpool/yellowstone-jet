use {
    ...
    tracing::error,
    uuid::Uuid,
    yellowstone_jet_tpu_client::core::{TpuSenderTxn, TpuSenderTxnInfo},
...
pub struct QuicGatewayBidi<Rx, Tx> {
    pub sink: Tx,
    pub source: Rx,
}
...
where
    Rx: Stream<Item = Arc<SendTransactionRequest>> + Unpin + Send + 'static,
